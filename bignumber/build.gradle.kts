...
mavenPublishing {
    ...
    pom {
        ...
        scm {
            url = "https://github.com/jianastrero/bignumber"
            connection = "scm:git:git://github.com/jianastrero/bignumber.git"
            developerConnection = "scm:git:ssh://git@github.com/jianastrero/bignumber.git"
        }
    }
}
